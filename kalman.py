...
# regresa el centro de un conjunto de puntos representando un rectangulo
...
# this function is called as a call-back everytime the trackbar is moved esta funcion es llamada
...
# define el nombre de la ventana
  ...
  windowName = "Reconocimiento de objeto con kalman"; # window name
  windowName2 = "Hue histogram back projection"; # window name
  windowNameSelection = "region seleccionada inicial";


#inicia el objeto con el filtro de kalman
